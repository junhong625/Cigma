...
const useDrawCodeEditor = (elementRef) => {
    ...
    useEffect(() => {
        ...
        const handleMouseDownCanvas = (event) => {
            ...
            const handleMouseUp = (e) => {
                ...
                const coordinates = {
                    ...
                    // width랑 height 추가하면 뭐가 달라지나?
                    height: canvasPreview.offsetHeight,
                    width: canvasPreview.offsetWidth,
                };

                coordinates.height + coordinates.width > 4 && dispatch(showCodeEditor(coordinates));
        ...
        return () => element.removeEventListener('mousedown', handleMouseDownCanvas);
